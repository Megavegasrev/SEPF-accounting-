...
- [`docs/DATABASE_REVIEW.md`](docs/DATABASE_REVIEW.md) — correctness/coherence
  review + the complete schema (tables, columns, keys, constraints, indexes,
  functions, RLS policies) and a Mermaid ER diagram, generated by
  [`db/tools/generate_schema_doc.py`](db/tools/generate_schema_doc.py).
